...
exports.buildRejectionEmail = exports.buildApprovalEmail = void 0;
...
`;
const buildApprovalEmail = (employeeName, leaveType, startDate, endDate, daysRequested, reason, approverName) => {
...
exports.buildApprovalEmail = buildApprovalEmail;
const buildRejectionEmail = (employeeName, leaveType, startDate, endDate, reason, rejecterName) => {
